            ...
            <div className='sticky top-0 left-0 h-screen flex flex-col border-r border-gray-700 w-20 md:w-full'>
                ...
                <ul className='flex flex-col gap-3 mt-4'>
                    ...
                    <div className='dropdown block lg:hidden'>
                        <div tabIndex={0} role='button' className='m-1 flex gap-3 items-center hover:bg-stone-900 transition-all rounded-full duration-300 py-2 md:pl-1 pr-4 max-w-fit cursor-pointer outline-none pl-5'>
                            <TbMoodHappy className='w-6 h-6' />
                            <span className='text-lg hidden md:block'>Your Mood</span>
                        </div>

                        <ul tabIndex={0} className='dropdown-content p-2 rounded-box '>
                            <li>
                                <div className=' py-4 rounded-md mt-2 bg-[#16181C]'>
                                    <UserMoodSelector />
                                </div>
                            </li>
                        </ul>
